...
import { TempoUpload } from "../modules/TempoUpload";
...
const upload = multer({ dest: "../client/public/uploads/" }).single("picture");

//***********************************/

router.get("/api/article", article.browse);
router.post("/api/article/upload", upload, TempoUpload);
