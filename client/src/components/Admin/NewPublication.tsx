...
export default function NewPublication() {
  // créer un formulaire pour ajouter une nouvelle publication
  ...
  const onSubmit = (data: PublicationType) => {
    console.info(data);
    // Ici, vous pouvez ajouter le code pour envoyer les données de la publication
